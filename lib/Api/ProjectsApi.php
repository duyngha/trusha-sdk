...
class ProjectsApi
{
     ...
     * Create a Project
     *
     * @param  \Swagger\Client\Model\V1ProjectsBody $body body (required)
     ...
     */
    public function createProject($body, $authorization)
    {
        list($response) = $this->createProjectWithHttpInfo($body, $authorization);
        return $response;
    }
     ...
     * Create a Project
     *
     * @param  \Swagger\Client\Model\V1ProjectsBody $body (required)
     * @param  string $authorization Your API Key in the format &#x60;[sandbox|live]_api_[0-9a-z]&#x60;. (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function createProjectWithHttpInfo($body, $authorization)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2005';
        $request = $this->createProjectRequest($body, $authorization);
     ...
     */
    public function createProjectAsync($body, $authorization)
    {
        return $this->createProjectAsyncWithHttpInfo($body, $authorization)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createProjectAsyncWithHttpInfo($body, $authorization)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2005';
        $request = $this->createProjectRequest($body, $authorization);
     ...
     */
    protected function createProjectRequest($body, $authorization)
    {
        ...
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $authorization when calling createProject'
            );
        }
