...
class ParticipantsApi
{
     ...
     *
     * @param  \Swagger\Client\Model\V1ParticipantsBody $body body (required)
     ...
     */
    public function createParticipant($body, $authorization)
    {
        list($response) = $this->createParticipantWithHttpInfo($body, $authorization);
        return $response;
    }
     ...
     * Create a Participant
     *
     * @param  \Swagger\Client\Model\V1ParticipantsBody $body (required)
     * @param  string $authorization Your API Key in the format &#x60;[sandbox|live]_api_[0-9a-z]&#x60;. (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function createParticipantWithHttpInfo($body, $authorization)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2006';
        $request = $this->createParticipantRequest($body, $authorization);
     ...
     */
    public function createParticipantAsync($body, $authorization)
    {
        return $this->createParticipantAsyncWithHttpInfo($body, $authorization)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createParticipantAsyncWithHttpInfo($body, $authorization)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2006';
        $request = $this->createParticipantRequest($body, $authorization);
     ...
     */
    protected function createParticipantRequest($body, $authorization)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling createParticipant'
            );
        }
        // verify the required parameter 'authorization' is set
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $authorization when calling createParticipant'
            );
        }

        $resourcePath = '/v1/participants';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
