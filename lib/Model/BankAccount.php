...
class BankAccount implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'id' => 'string',
'country' => 'AllOfBankAccountCountry',
'currency' => 'AllOfBankAccountCurrency',
'account_number' => 'string',
'routing_code' => 'string',
'routing_code_type' => 'AllOfBankAccountRoutingCodeType',
'routing_data' => 'object'    ];
...
'routing_data' => 'getRoutingData'    ];
     ...
     * Sets id
     *
     * @param string $id A unique ID for the bank_account.  A string in the format `bank_account_[0-9a-z]`.
     *
     * @return $this
     */
     ...
     * Gets country
     *
     * @return AllOfBankAccountCountry
     */
     ...
     * Sets country
     *
     * @param AllOfBankAccountCountry $country The country the bank account is held in.
     *
     * @return $this
     */
     ...
     * Gets currency
     *
     * @return AllOfBankAccountCurrency
     */
     ...
     * Sets currency
     *
     * @param AllOfBankAccountCurrency $currency The currency the bank account is held in.
     *
     * @return $this
     */
     ...
     * Sets routing_code
     *
     * @param string $routing_code The routing code of the bank account.
     *
     * @return $this
     */
     ...
     *
     * @return AllOfBankAccountRoutingCodeType
     */
     ...
     *
     * @param AllOfBankAccountRoutingCodeType $routing_code_type The routing code type of the bank account.
     *
     * @return $this
     */
     ...
     * Sets routing_data
     *
     * @param object $routing_data An object potentially containing further routing data.
     *
     * @return $this
     */
