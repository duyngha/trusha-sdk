...
'created_at' => 'string',
'updated_at' => 'string',
'type' => 'AllOfCheckoutType',
'status' => 'AllOfCheckoutStatus',
'participant' => 'AllOfCheckoutParticipant',
'amount' => 'int',
'reference' => 'string',
'intent_id' => 'string',
'project_id' => 'string',
'transfers' => '\Swagger\Client\Model\AllOfCheckoutTransfersItems[]',
'metadata' => 'object'    ];
...
'metadata' => 'getMetadata'    ];
     ...
     * Sets id
     *
     * @param string $id A unique ID for the checkout.  A string in the format `checkout_[0-9a-z]`.
     *
     * @return $this
     */
     ...
     * Sets created_at
     *
     * @param string $created_at The date the checkout was created.
     *
     * @return $this
     */
     ...
     * Sets updated_at
     *
     * @param string $updated_at The date the checkout was last updated.
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param AllOfCheckoutType $type The type of the checkout.
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param AllOfCheckoutStatus $status The status of the checkout.
     *
     * @return $this
     */
     ...
     * Gets participant
     *
     * @return AllOfCheckoutParticipant
     */
     ...
     * Sets participant
     *
     * @param AllOfCheckoutParticipant $participant The buyer Participant of the checkout.
     *
     * @return $this
     */
     ...
     * Sets amount
     *
     * @param int $amount The amount of the checkout.
     *
     * @return $this
     */
     ...
     * Sets reference
     *
     * @param string $reference The unique reference for the checkout.
     *
     * @return $this
     */
     ...
     * Sets intent_id
     *
     * @param string $intent_id The unique ID of the intent which caused the checkout to be created. This value will be null if the checkout was created via our Direct mechanism.
     *
     * @return $this
     */
     ...
     * Sets project_id
     *
     * @param string $project_id The unique ID of the project which this checkout will fund.
     *
     * @return $this
     */
     ...
     * Gets transfers
     *
     * @return \Swagger\Client\Model\AllOfCheckoutTransfersItems[]
     */
     ...
     * Sets transfers
     *
     * @param \Swagger\Client\Model\AllOfCheckoutTransfersItems[] $transfers A list of fee transfers associated with the checkout.
     *
     * @return $this
     */
     ...
     * Sets metadata
     *
     * @param object $metadata The metadata that was provided at the creation of the payment intent that caused this checkout.
     *
     * @return $this
     */
