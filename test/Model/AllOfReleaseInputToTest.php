...
/**
 * AllOfReleaseInputToTest Class Doc Comment
 *
 * @category    Class
 * @description An object describing the beneficiary participant to release to.  You can only provide a participant at release when the settlement is of type &#x60;funded&#x60; or you are releasing directly from a project.
 * @package     Swagger\Client
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class AllOfReleaseInputToTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * Test "AllOfReleaseInputTo"
     */
    public function testAllOfReleaseInputTo()
    {
    }
}
