<?php
/**
 * AllOfPaymentIntentCurrencyTest
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * AllOfPaymentIntentCurrencyTest Class Doc Comment
 *
 * @category    Class
 * @description The currency of the payment intent. If this payment intent is not against an existing Project, the currency here will dictate the currency that the transactional account should be provisioned for.
 * @package     Swagger\Client
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class AllOfPaymentIntentCurrencyTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * Test "AllOfPaymentIntentCurrency"
     */
    public function testAllOfPaymentIntentCurrency()
    {
    }
}
