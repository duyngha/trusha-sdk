...
class Conversion implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'from' => 'AllOfConversionFrom',
'to' => 'AllOfConversionTo',
'status' => 'AllOfConversionStatus',
'expected_amount' => 'int',
'rate' => 'float'    ];
...
'rate' => 'getRate'    ];
     ...
     * Sets from
     *
     * @param AllOfConversionFrom $from The currency being converted.
     *
     * @return $this
     */
     ...
     * Sets to
     *
     * @param AllOfConversionTo $to The target currency of the conversion.
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param AllOfConversionStatus $status The status of the conversion.
     *
     * @return $this
     */
     ...
     *
     * @param int $expected_amount The expected amount of the conversion in the target currency. The amount is always in the lowest denomination of the target currency, so please be aware of the target currencies _minor unit_.
     *
     * @return $this
     */
     ...
     * Sets rate
     *
     * @param float $rate The conversion rate in the form `from` -> `to`.
     *
     * @return $this
     */
