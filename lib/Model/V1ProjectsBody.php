...
/**
 * V1ProjectsBody Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1ProjectsBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1_projects_body';
    ...
    protected static $swaggerTypes = [
        'currency' => 'AllOfv1ProjectsBodyCurrency',
'metadata' => 'object'    ];
...
'metadata' => 'getMetadata'    ];
     ...
     * Gets currency
     *
     * @return AllOfv1ProjectsBodyCurrency
     */
     ...
     * Sets currency
     *
     * @param AllOfv1ProjectsBodyCurrency $currency The currency the project account will be held in.
     *
     * @return $this
     */
     ...
     * Sets metadata
     *
     * @param object $metadata A free-form metadata object that you can use to store against the project. This is incredibly useful for storing a correlation ID that relates to an entity on your own system.
     *
     * @return $this
     */
