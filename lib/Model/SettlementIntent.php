...
/**
 * SettlementIntent Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SettlementIntent implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SettlementIntent';
    ...
    protected static $swaggerTypes = [
        'created_at' => 'string',
'updated_at' => 'string',
'to' => 'AllOfSettlementIntentTo',
'type' => 'AllOfSettlementIntentType',
'amount' => 'int',
'description' => 'string',
'summary' => 'string',
'fee_flat' => 'int',
...
'metadata' => 'getMetadata'    ];
     ...
     * Sets created_at
     *
     * @param string $created_at The date the settlement intent was created.
     *
     * @return $this
     */
     ...
     * Sets updated_at
     *
     * @param string $updated_at The date the settlement intent was last updated.
     *
     * @return $this
     */
     ...
     * Gets to
     *
     * @return AllOfSettlementIntentTo
     */
     ...
     * Sets to
     *
     * @param AllOfSettlementIntentTo $to The beneficiary Participant of the settlement intent. Where the type is `funding` this will be `null`.
     *
     * @return $this
     */
     ...
     * Gets type
     *
     * @return AllOfSettlementIntentType
     */
     ...
     * Sets type
     *
     * @param AllOfSettlementIntentType $type The settlement intent type.
     *
     * @return $this
     */
     ...
     * Sets amount
     *
     * @param int $amount The amount of the settlement intent.
     *
     * @return $this
     */
     ...
     * Sets description
     *
     * @param string $description A description of the reason for the settlement.
     *
     * @return $this
     */
     ...
     * Sets summary
     *
     * @param string $summary An optional summary of the settlement.
     *
     * @return $this
     */
     ...
     * Sets fee_flat
     *
     * @param int $fee_flat The flat fee the beneficiary Participant will be pay on each release from the settlement.
     *
     * @return $this
     */
     ...
     * Sets fee_percentage
     *
     * @param float $fee_percentage The percentage fee the beneficiary Participant will pay on each release from the settlement.
     *
     * @return $this
     */
     ...
     * Sets metadata
     *
     * @param object $metadata The metadata that was provided at the creation of the settlement intent.
     *
     * @return $this
     */
