...
'country' => 'getCountry'    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['town_city'] === null) {
            $invalidProperties[] = "'town_city' can't be null";
        }
     ...
     * Sets type
     *
     * @param AllOfAddressInputType $type The type of the address, defaults to `unknown`.
     *
     * @return $this
     */
