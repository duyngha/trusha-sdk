...
const LOCAL_BANK_TRANSFER = 'local_bank_transfer';
const INTERNATIONAL_BANK_TRANSFER = 'international_bank_transfer';
    /**
    ...
    public static function getAllowableEnumValues()
    {
        return [
            self::CARD,
self::OPEN_BANKING,
self::LOCAL_BANK_TRANSFER,
self::INTERNATIONAL_BANK_TRANSFER,        ];
    }
}
