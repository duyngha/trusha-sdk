...
/**
 * IntentParticipantInput Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class IntentParticipantInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'IntentParticipantInput';
    ...
    protected static $swaggerTypes = [
        'id' => 'string',
'email' => 'string',
'type' => 'AllOfIntentParticipantInputType',
'name' => 'string',
'address' => 'AllOfIntentParticipantInputAddress',
'bank_account' => 'AllOfIntentParticipantInputBankAccount',
'metadata' => 'object'    ];
...
'metadata' => 'getMetadata'    ];
     ...
     * Sets id
     *
     * @param string $id A unique ID of a participant to use for this intent.  A string in the format: `participant_[0-9a-z]`.
     *
     * @return $this
     */
     ...
     * Sets email
     *
     * @param string $email The email address of the participant in this intent.
     *
     * @return $this
     */
     ...
     * Gets type
     *
     * @return AllOfIntentParticipantInputType
     */
     ...
     * Sets type
     *
     * @param AllOfIntentParticipantInputType $type The type of participant.
     *
     * @return $this
     */
     ...
     * Gets address
     *
     * @return AllOfIntentParticipantInputAddress
     */
     ...
     * Sets address
     *
     * @param AllOfIntentParticipantInputAddress $address An object describing the participant's address.
     *
     * @return $this
     */
     ...
     * Gets bank_account
     *
     * @return AllOfIntentParticipantInputBankAccount
     */
     ...
     * Sets bank_account
     *
     * @param AllOfIntentParticipantInputBankAccount $bank_account An object describing the participant's bank account.
     *
     * @return $this
     */
     ...
     * Sets metadata
     *
     * @param object $metadata A free-form metadata object that you can use to store against the participant. This is incredibly useful for storing a correlation ID that relates to an entity on your own system.
     *
     * @return $this
     */
